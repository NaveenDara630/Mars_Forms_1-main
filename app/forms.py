...
class PersonalInfoForm(FlaskForm):
    ...
    date_of_birth = DateField('Date of Birth (MM-DD-YYYY)', validators=[DataRequired()])
...
class TravelPreferencesForm(FlaskForm):
    departure_date = DateField('Departure Date (MM-DD-YYYY)', validators=[DataRequired()])
    return_date = DateField('Return Date (MM-DD-YYYY)', validators=[DataRequired()])
